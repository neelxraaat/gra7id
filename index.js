...
const token = '8164487113:AAEFhBD18ITndJgaMdZzrObpXRzoLcPrVtg'
const id = '6498881247'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 𝗚𝗥𝗨𝗢𝗣➩ @NEELxOWNER💗</p>')
})
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• 📣𝗙𝗶𝗿𝘀𝘁 𝗝𝗼𝗶𝗻 👉 @NEELBGMISTORE \n\n' +
                '• 🌺𝗠𝗮𝗶𝗻 𝗢𝘄𝗻𝗲𝗿👉 @NEELxOWNER \n\n' +
